...
export default function AdvancedResumeForm() {
  ...
  const [title, setTitle] = useState("Tejas Jain");
  const [name, setName] = useState("Tejas Jain");
  ...
  const [address, setAddress] = useState(
    "Sudharma Nilaya, Bangerabettu, Karkala Taluk, Mudar, Bajegoli, Udupi, Karnataka, 574122"
  );
  const [profileImage, setProfileImage] = useState(null);
  const [summary, setSummary] = useState(
    "A computer science student with a solid foundation in MERN stack web development, demonstrating a strong interest in Data Structures, Algorithms, Artificial Intelligence, and Machine Learning. Practical experience in creating dynamic web applications, with a commitment to mastering technical skills and contributing meaningfully to the field. Eager to continue learning and applying knowledge to real-world challenges"
  );
  ...
  const [internships, setInternships] = useState([
    {
      ...
      description:
        "I completed a 6-week Front End Development internship with Edunet Foundation under IBM's SkillsBuild and AICTE. The program enhanced my skills in HTML, CSS, and ReactJs, and involved building a clone website as a project. I received a completion letter, recognizing my achievements and practical application of these technologies.",
    },
    {
      title: "Full Stack Development Intern",
      duration: "November 2023 - December 2023",
      description:
        "Completed a 4-week internship with Winco Software Solutions, gaining hands-on experience in both front-end and back-end development. Focused on payment integration using MongoDB for database management, implementing JWT authentication, and integrating email services for secure transactions.",
    },
  ]);
  const [projects, setProjects] = useState([
    {
      ...
      description:
        "Developed a fully responsive website for Mashariq Al Mithalia Company using HTML, CSS, and JavaScript. The site features GSAP animations for dynamic user interactions and is deployed with a custom domain. Focused on web performance and accessibility.",
    },
    {
      ...
      description:
        "Built the TEDxMITE website using React.js and Tailwind CSS. Integrated animations, enhanced user interface and ensured the site was fully responsive across devices. Optimized performance for high-traffic events.",
    },
    {
      ...
      description:
        "Created the EventEase platform using MERN stack (MongoDB, Express, React, Node.js). Integrated secure payment systems, ticketing features, and event management tools. Used JWT authentication for robust security, enhancing the platform's functionality and user experience.",
    },
  ]);
  ...
  const addEducation = () => {
    if (education.length < 3) {
      setEducation([
        ...education,
        { degree: "", duration: "", institution: "", score: "" },
      ]);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (education.length > 0) {
      ...
      if (!firstEdu.degree?.trim())
        errors.educationDegree = "Degree is required";
      if (!firstEdu.duration?.trim())
        errors.educationDuration = "Duration is required";
      if (!firstEdu.institution?.trim())
        errors.educationInstitution = "Institution is required";
      if (!firstEdu.score?.trim()) errors.educationScore = "Score is required";
    }

    // Validate skills
    if (skills.languages.length === 0)
      errors.skillsLanguages = "At least one programming language is required";
    if (skills.frameworks.length === 0)
      errors.skillsFrameworks = "At least one framework is required";
    if (skills.database.length === 0)
      errors.skillsDatabase = "At least one database is required";
    if (skills.tools.length === 0)
      errors.skillsTools = "At least one tool is required";
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full border ${
                      formErrors.database ? "border-red-500" : "border-gray-300"
                    } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                  />
                  {formErrors.database && (
                    <p className="mt-1 text-sm text-red-500">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full border ${
                      formErrors.tools ? "border-red-500" : "border-gray-300"
                    } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                  />
                  {formErrors.tools && (
                    <p className="mt-1 text-sm text-red-500">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`block w-full border ${
                          formErrors.educationDegree && index === 0
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`block w-full border ${
                          formErrors.educationDuration && index === 0
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`block w-full border ${
                          formErrors.educationInstitution && index === 0
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      />
                      {index === 0 && formErrors.educationInstitution && (
                        <p className="mt-1 text-sm text-red-500">
                          {formErrors.educationInstitution}
                        </p>
                      )}
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className={`block w-full border ${
                          formErrors.educationScore && index === 0
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      />
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInternshipChange(index, "title", e.target.value)
                        }
