...
const FormComponentGoogle = () => {
  ...
  const handleTechnologyChange = (e, index) => {
    ...
    newProjects[index].filteredTechnologies = COMMON_TECHNOLOGIES.filter(
  ...
  const addTechnology = (projectIndex, tech = null) => {
    ...
    if (
      technology.trim() !== "" &&
      !newProjects[projectIndex].technologies.includes(technology.trim())
    ) {
  ...
  const removeTechnology = (projectIndex, techIndex) => {
    ...
    newProjects[projectIndex].isTechnologiesValid =
      newProjects[projectIndex].technologies.length > 0;
    setProjects(newProjects);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValid) {
      ...
      document
        .getElementById(`project-${firstInvalidProject}`)
    ...
    if (languages.length === 0) {
      ...
      document
        .getElementById("languages-section")
        .scrollIntoView({ behavior: "smooth" });
      return;
    }
                  ...
                  >
                    ...
                    <div className="flex mt-1">
                      <input
                        ...
                        onFocus={() =>
                          handleProjectChange(index, "isDropdownOpen", true)
                        }
                    ...
                    {project.isDropdownOpen &&
                      project.filteredTechnologies.length > 0 && (
                        <ul className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                          {project.filteredTechnologies.map(
                            (tech, techIndex) => (
                              <li
                                key={techIndex}
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => (
                        <span
                          key={techIndex}
                          className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold bg-indigo-100 text-indigo-800"
                        >
                          {tech}
                          <button
                            type="button"
              ...
              <div className="relative" ref={skillDropdownRef}>
                <div className="flex mt-1">
                  <input
                    ...
                    className={`block w-full border ${
                      !isSkillsValid ? "border-red-300" : "border-gray-300"
                    } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              ...
              {awards.length > 0 && (
                <div className="mt-4 space-y-2">
                  {awards.map((award, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between bg-white border border-gray-200 px-4 py-2 rounded-md shadow-sm"
                    >
            ...
            <div id="languages-section">
              ...
              <div className="relative" ref={languageDropdownRef}>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className={`flex-grow mt-1 block w-full border ${
                      !isLanguagesValid ? "border-red-300" : "border-gray-300"
                    } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {languages.map((language, index) => (
                  <div
                    key={index}
                    className="inline-flex items-center px-3 py-1.5 rounded-md text-sm font-semibold bg-indigo-100 text-indigo-800"
                  >
                    {language}
                    <button
                      type="button"
